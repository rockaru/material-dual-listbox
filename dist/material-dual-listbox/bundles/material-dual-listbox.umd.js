    ...
    ***************************************************************************** */
    ...
    var MaterialDualListboxComponent = /** @class */ (function () {
        ...
        MaterialDualListboxComponent.prototype.clickedItem = function (item) {
            ...
            this[targets[0]] = __spread(this[targets[1]].splice(this[targets[1]].indexOf(item), 1), this[targets[0]]);
            this.destination = this.confirmedFiltered;
            this.destinationChange.emit(this.destination);
        };
        ...
        MaterialDualListboxComponent.prototype.filterSelectedItems = function (text) {
            ...
            this.confirmedFiltered = this.destination.filter(function (item) { return item[_this.display].toLowerCase().includes(text.toLowerCase()); });
        };
